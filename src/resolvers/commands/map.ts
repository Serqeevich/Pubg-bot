...
const miramar = {
  ...
  const taego = {
    name: `Taego`,
    places: [
       { name: `Ho san`, img: `https://cdn.discordapp.com/attachments/939806800679690260/943068581258735616/Unranked-min.png`},
...
const MapResolver: CommandResolver = async (client, message, argumentsParsed) => {
  ...
  const words = argumentsParsed._[1];
   ...
   message.channel.send(`Играете на ${map.name}?\nУдачи в **${randomPlace.name}**! 🪂`,
